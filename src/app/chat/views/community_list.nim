  ...
  method roleNames(self: CommunityList): Table[int, string] =
    {
      ...
      CommunityRoles.Joined.int: "ensOnly",
      CommunityRoles.Joined.int: "canRequestAccess",
      CommunityRoles.Joined.int: "canManageUsers",
      CommunityRoles.Joined.int: "canJoin",
      CommunityRoles.Joined.int: "isMember",
